...
⚠️ Gap: no notes on why we passed on #3 — the memo was never filed.`,
    ...
    legal: {
      ...
      metaDesc: "Synthesize case files, surface contradictions, track deadlines — on infrastructure you control. The privacy-first alternative to US legal AI clouds.",
      badge: "For law firms & legal teams",
      h1a: "500 pages of case file.",
      h1b: "One question away.",
      sub: "Ask “where do the opposing party's statements contradict each other?” and get an answer with page-level citations — on infrastructure your firm controls.",
      painsTitle: "Sound familiar?",
      pains: [
...
⚠️ Gap: exhibit B7's authenticity hasn't been addressed by either side yet.`,
      ...
      features: [
        { icon: "Shield", title: "Your server, your jurisdiction", desc: "Self-host the full engine on firm hardware, or choose EU-hosted cloud with a DPA. Client data never leaves your control." },
      ...
      faq: [
        ...
        { q: "Can we run it fully offline?", a: "The engine self-hosts on your hardware. Synthesis uses LLM APIs of your choosing; enterprise setups can route through EU endpoints or your own gateway." },
      ...
      ctaButton: "Start your case brain",
    },
    tax: {
      slug: "tax",
...
⚠️ Lücke: Zu Nr. 3 fehlt das Pass-Memo — wurde nie abgelegt.`,
    ...
    legal: {
      ...
      metaDesc: "Akten synthetisieren, Widersprüche finden, Fristen im Blick — auf Infrastruktur, die ihr kontrolliert. Die Privacy-First-Alternative zu US-Legal-AI-Clouds.",
      badge: "Für Kanzleien & Rechtsabteilungen",
      h1a: "500 Seiten Akte.",
      h1b: "Eine Frage entfernt.",
      sub: "Frag „wo widersprechen sich die Aussagen der Gegenseite?“ und erhalte eine Antwort mit seitengenauen Zitaten — auf Infrastruktur, die eure Kanzlei kontrolliert.",
      painsTitle: "Kommt dir bekannt vor?",
      pains: [
...
⚠️ Lücke: Die Echtheit von Anlage B7 wurde bisher von keiner Seite thematisiert.`,
      ...
      features: [
        { icon: "Shield", title: "Euer Server, eure Jurisdiktion", desc: "Volle Engine self-hosted auf Kanzlei-Hardware — oder EU-Cloud mit AVV. Mandantendaten verlassen nie eure Kontrolle." },
      ...
      faq: [
        ...
        { q: "Können wir komplett offline arbeiten?", a: "Die Engine läuft self-hosted auf eurer Hardware. Die Synthese nutzt LLM-APIs eurer Wahl; Enterprise-Setups können über EU-Endpunkte oder ein eigenes Gateway routen." },
