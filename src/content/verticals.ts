...
⚠️ Gap: no notes on why we passed on #3 — the memo was never filed.`,
    ...
    legal: {
      ...
      sub: "Ask “where do the opposing party's statements contradict each other?”, book time from WhatsApp, attach voice notes and PDFs to a matter, invoice open work — on infrastructure your firm controls.",
      painsTitle: "Sound familiar?",
      pains: [
...
⚠️ Lücke: Zu Nr. 3 fehlt das Pass-Memo — wurde nie abgelegt.`,
    ...
    legal: {
      ...
      sub: "Frag „wo widersprechen sich die Aussagen der Gegenseite?“, buche Zeiten per WhatsApp, hänge Voice-Notes und PDFs an Akten, rechne offene Arbeit ab — auf Infrastruktur, die eure Kanzlei kontrolliert.",
      painsTitle: "Kommt dir bekannt vor?",
      pains: [
