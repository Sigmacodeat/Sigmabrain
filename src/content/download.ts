...
export const DOWNLOAD: Record<Lang, DownloadContent> = {
  en: {
    ...
    faq: [
      { q: "Is the installed app different from the website?", a: "Same product, same account, same data. The install gives you a full-screen window, a home-screen icon, and an offline fallback. Native store versions will add push notifications and share extensions." },
      { q: "Does it work offline?", a: "The app shell loads offline and tells you clearly when it can't reach your brain. Queries need a connection — your brain lives on your server or your EU cloud instance, not on the phone." },
      { q: "Is the mobile app secure?", a: "It's the same hardened web app: encrypted transport, httpOnly session cookies, and your data never stored on the device beyond the session." },
  ...
  de: {
    ...
    faq: [
      { q: "Unterscheidet sich die installierte App von der Website?", a: "Gleiches Produkt, gleiches Konto, gleiche Daten. Die Installation gibt dir ein Vollbild-Fenster, ein Home-Screen-Icon und einen Offline-Fallback. Native Store-Versionen ergänzen Push-Benachrichtigungen und Share-Extensions." },
      { q: "Funktioniert es offline?", a: "Die App-Hülle lädt offline und sagt dir klar, wenn sie dein Brain nicht erreicht. Queries brauchen eine Verbindung — dein Brain lebt auf deinem Server oder deiner EU-Cloud-Instanz, nicht auf dem Handy." },
      { q: "Ist die mobile App sicher?", a: "Es ist dieselbe gehärtete Web-App: verschlüsselter Transport, httpOnly-Session-Cookies, und deine Daten werden über die Session hinaus nicht auf dem Gerät gespeichert." },
