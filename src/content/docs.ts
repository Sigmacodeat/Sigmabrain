...
export interface DocFeature { icon: string; title: string; desc: string; }
export interface DocCategory { id: string; title: string; sub: string; features: DocFeature[]; }
...
const DE: DocsContent = {
  ...
  categories: [
    { id: "brain", title: "Brain & KI", sub: "Semantisches Wissen, zitierte Antworten, Agenten.", features: [
      ...
      { icon: "Search", title: "KI-Chat mit Fundstellen", desc: "Jede Antwort zitiert die exakte Seite. Halluzinierte Zitate werden verworfen — RAG mit Groundedness-Check." },
      { icon: "Zap", title: "Think / Reasoning", desc: "Deep-reasoning für komplexe Rechtsfragen. Trajectory-Tracking für zeitliche Entwicklungen und Metriken." },
      { icon: "Network", title: "Agenten-System", desc: "Eigene Agenten erstellen und über API steuern. Skill-basiert, evaluierbar, federated über Multiple Brains." },
      { icon: "GitBranch", title: "Graph & Entity View", desc: "Netzwerkansicht aller Entitäten und Beziehungen. Verborgene Verbindungen zwischen Mandanten und Gegenstellen." },
      { icon: "ScanSearch", title: "RAG Evaluation", desc: "Eingebautes Benchmark-System für Retrieval-Qualität. Replay gegen erfasste Queries, LongMemEval-Support." },
      { icon: "Zap", title: "KI-Assistent", desc: "Integrierter KI-Assistent im Dashboard. Kontextbewusste Hilfe für alle Workflow-Schritte — von der Aktenanlage bis zur Rechnung." },
    ]},
    { id: "cases", title: "Akten & Dokumente", sub: "Aktenverwaltung, DMS-Integration, Dokumentenverarbeitung.", features: [
      { icon: "FolderOpen", title: "Aktenverwaltung", desc: "Mandanten- und Aktenstruktur mit Zugriffsrechten pro Nutzer und Akte. Fuzz-getestet auf zero leaks." },
      { icon: "FileText", title: "Dokumenten-Upload & Vault", desc: "Drag-and-drop, revisionssichere Speicherung, Versionierung. Lokaler Vault oder verschlüsselter EU-Cloud-Speicher." },
      { icon: "Database", title: "DMS-Integrationen", desc: "Native Anbindung an NetDocuments, iManage, Google Drive. Bi-direktionale Synchronisation." },
      { icon: "Layers", title: "OCR & Dokumentenverarbeitung", desc: "Texterkennung, Klassifizierung, Named-Entity-Recognition. PDFs, Scans und Bilder werden durchsuchbar." },
    ...
    { id: "deadlines", title: "Fristen & Zeit", sub: "Automatische Fristenerkennung, Kalender-Export, Zeiterfassung.", features: [
      ...
      { icon: "Zap", title: "AI-Fristenerkennung", desc: "KI scannt automatisch alle Dokumente und Emails nach Fristen, Terminen und Deadlines — ohne manuelle Eingabe." },
      { icon: "CalendarClock", title: "Kalender-Export", desc: "Synchronisation mit Outlook, Google Calendar, Apple Calendar. Fristen als Kalendereinträge exportiert." },
      { icon: "Calculator", title: "Zeiterfassung & Auslagen", desc: "Per Chat, WhatsApp oder manuell — Zeiten und Auslagen der richtigen Akte zugeordnet, bestätigungspflichtig." },
    ]},
    { id: "invoicing", title: "Rechnung & Finanzen", sub: "Rechnungsstellung, DATEV-Export, RVG, Mahnwesen.", features: [
      { icon: "FileText", title: "Rechnungsstellung", desc: "Automatische Rechnungsgenerierung aus Zeiterfassung. Professionelle PDF-Vorlagen mit Logo und Bankverbindung." },
      { icon: "Database", title: "DATEV-Export", desc: "Export aller Buchungsdaten im DATEV-kompatiblen Format für die Kanzlei-Buchhaltung." },
    ...
    { id: "security", title: "Sicherheit & Compliance", sub: "DSGVO, GoBD, AI Act, Audit Trail, Verschlüsselung.", features: [
      ...
      { icon: "FileText", title: "GoBD / Verfahrensdokumentation", desc: "Vollautomatische GoBD-Verfahrensdokumentation. Jede Aktion revisionssicher protokolliert — prüfungsfest." },
      { icon: "ShieldAlert", title: "AI Act Compliance", desc: "Eingebauter EU AI Act Compliance-Checker. Risikostufen, Dokumentationspflichten, Konformitätsnachweise." },
      { icon: "Database", title: "Audit Trail", desc: "Lückenlose Protokollierung jeder Aktion: wer hat wann was mit welchem Dokument gemacht — unveränderbar." },
      { icon: "Lock", title: "Verschlüsselung", desc: "End-to-End-Verschlüsselung At-Rest und In-Transit. Schlüsselhaltung beim Kunden bei Self-Hosting." },
    ...
    { id: "integrations", title: "Integrationen", sub: "DocuSign, Connectors, API, SSO, Webhooks.", features: [
      ...
      { icon: "Network", title: "Connectors", desc: "Offene API für Drittsysteme. Webhook-basierte Echtzeit-Synchronisation mit beliebigen Tools." },
    ...
    { id: "automation", title: "Automatisierung", sub: "Cron Jobs, Rechtsprechung, Fristen-Scanner, Agents.", features: [
      ...
      { icon: "CalendarClock", title: "Fristen-Scanner", desc: "Automatischer Scan aller Dokumente auf Fristen. Keine Frist wird mehr übersehen." },
    ...
    { id: "specialized", title: "Spezialmodule", sub: "Branchenspezifisch: Recht, Medizin, Immobilien, Versicherung.", features: [
      ...
      { icon: "FileText", title: "Medizinrecht", desc: "Gutachtenanalyse, MDK-Schreiben, Krankenakten-Review, Fristenkatalog für Medizinrechtler." },
    ...
    { id: "mobile", title: "Mobile & Offline", sub: "App, Offline-Sync, mobile Brücke.", features: [
      ...
      { icon: "Database", title: "Offline-Sync", desc: "Arbeiten ohne Internet. Lokale Speicherung, konfliktfreie Synchronisation beim Wiedereinstieg." },
      { icon: "MessageSquare", title: "Mobile Brücke", desc: "Nahtloser Handover Desktop ↔ Mobile. Auf dem HPhone begonnen, im Browser fortgesetzt." },
    ]},
    { id: "legal-ai", title: "Rechtsspezifische KI", sub: "Vertragsentwürfe, Redlining, Konfliktprüfung, Anonymisierung.", features: [
      { icon: "FileText", title: "Vertragsentwürfe", desc: "KI-generierte Entwürfe auf Basis von Mustern. AGB, Arbeitsverträge, Kaufverträge, Mietverträge." },
  ...
  arch: {
    ...
    items: [
      { icon: "Database", title: "72 API Endpunkte", desc: "Vollständige REST-API mit Auth, Rate-Limiting, Audit-Logging und TypeScript-Typen." },
      { icon: "FolderOpen", title: "57 Dashboard-Seiten", desc: "Jede Funktion hat eine eigene, responsive Seite — von der Akte bis zum Kostenrechner." },
      { icon: "Shield", title: "Self-Hosted oder EU-Cloud", desc: "Lokale Docker-Installation oder gehostet in der EU mit AVV. Daten verlassen nie eure Kontrolle." },
      { icon: "Network", title: "Multi-Brain / Multi-Source", desc: "Mehrere Brains pro Organisation, mehrere Sources pro Brain. Federated Search über Latent Space." },
      { icon: "Lock", title: "End-to-End-Verschlüsselung", desc: "At-Rest und In-Transit. Kein Training auf Mandantendaten. § 203 StGB im Systemdesign." },
      { icon: "Zap", title: "Echtzeit-Sync", desc: "WebSocket-basierte Echtzeit-Updates zwischen allen Clients. Kein Refresh nötig." },
    ],
  },
  cta: { title: "Keine Funktion verstanden?", sub: "Jedes Feature ist im Dashboard ausprobiert — nicht nur dokumentiert.", button: "Dashboard öffnen" },
};
...
const EN: DocsContent = {
  ...
  categories: [
    { id: "brain", title: "Brain & AI", sub: "Semantic knowledge, cited answers, agents.", features: [
      ...
      { icon: "Search", title: "AI Chat with Citations", desc: "Every answer cites the exact page. Hallucinated citations are dropped — RAG with groundedness check." },
      { icon: "Zap", title: "Think / Reasoning", desc: "Deep-reasoning for complex legal questions. Trajectory tracking for temporal developments." },
      { icon: "Network", title: "Agent System", desc: "Create and control custom agents via API. Skill-based, evaluable, federated across multiple brains." },
      { icon: "GitBranch", title: "Graph & Entity View", desc: "Network view of all entities and relationships. Discovers hidden connections between clients and opponents." },
      { icon: "ScanSearch", title: "RAG Evaluation", desc: "Built-in benchmark system for retrieval quality. Replay against captured queries, LongMemEval support." },
      { icon: "Zap", title: "AI Assistant", desc: "Integrated AI assistant in the dashboard. Context-aware help for every workflow step — from case creation to invoicing." },
    ]},
    { id: "cases", title: "Cases & Documents", sub: "Case management, DMS integration, document processing.", features: [
      { icon: "FolderOpen", title: "Case Management", desc: "Client and case structure with per-user and per-case access rights. Fuzz-tested for zero leaks." },
      { icon: "FileText", title: "Document Upload & Vault", desc: "Drag-and-drop, audit-proof storage, versioning. Local vault or encrypted EU cloud storage." },
      { icon: "Database", title: "DMS Integrations", desc: "Native connection to NetDocuments, iManage, Google Drive. Bi-directional synchronization." },
      { icon: "Layers", title: "OCR & Document Processing", desc: "Text recognition, classification, NER. PDFs, scans and images become searchable." },
    ...
    { id: "deadlines", title: "Deadlines & Time", sub: "Automatic deadline detection, calendar export, time tracking.", features: [
      ...
      { icon: "Zap", title: "AI Deadline Detection", desc: "AI automatically scans all documents and emails for deadlines, appointments and due dates — no manual entry." },
      { icon: "CalendarClock", title: "Calendar Export", desc: "Sync with Outlook, Google Calendar, Apple Calendar. Deadlines exported as calendar entries." },
      { icon: "Calculator", title: "Time Tracking & Expenses", desc: "Via chat, WhatsApp or manual — times and expenses assigned to the correct case, confirmation-gated." },
    ]},
    { id: "invoicing", title: "Billing & Finance", sub: "Invoicing, DATEV export, fee calculation, dunning.", features: [
      { icon: "FileText", title: "Invoicing", desc: "Automatic invoice generation from time tracking. Professional PDF templates with logo and bank details." },
      { icon: "Database", title: "DATEV Export", desc: "Export all booking data in DATEV-compatible format for the firm's accounting system." },
    ...
    { id: "security", title: "Security & Compliance", sub: "GDPR, GoBD, AI Act, audit trail, encryption.", features: [
      ...
      { icon: "FileText", title: "GoBD / Process Documentation", desc: "Fully automatic GoBD process documentation. Every action audit-proof logged — inspection-ready." },
      { icon: "ShieldAlert", title: "AI Act Compliance", desc: "Built-in EU AI Act compliance checker. Risk levels, documentation obligations, conformity evidence." },
      { icon: "Database", title: "Audit Trail", desc: "Complete logging of every action: who did what when with which document — immutable." },
      { icon: "Lock", title: "Encryption", desc: "End-to-end encryption at-rest and in-transit. Key custody with the customer for self-hosting." },
    ...
    { id: "integrations", title: "Integrations", sub: "DocuSign, connectors, API, SSO, webhooks.", features: [
      ...
      { icon: "Network", title: "Connectors", desc: "Open API for third-party systems. Webhook-based real-time sync with any tool." },
    ...
    { id: "automation", title: "Automation", sub: "Cron jobs, case law, deadline scanner, agents.", features: [
      ...
      { icon: "CalendarClock", title: "Deadline Scanner", desc: "Automatic scan of all documents for deadlines. No deadline is missed again." },
    ...
    { id: "specialized", title: "Specialized Modules", sub: "Industry-specific: law, medicine, real estate, insurance.", features: [
      ...
      { icon: "FileText", title: "Medical Law", desc: "Opinion analysis, MDK letters, medical record review, deadline catalog for medical lawyers." },
    ...
    { id: "mobile", title: "Mobile & Offline", sub: "App, offline sync, mobile bridge.", features: [
      ...
      { icon: "Database", title: "Offline Sync", desc: "Work without internet. Local storage, conflict-free sync on reconnection." },
      { icon: "MessageSquare", title: "Mobile Bridge", desc: "Seamless handover desktop ↔ mobile. Started on phone, continued in browser." },
    ]},
    { id: "legal-ai", title: "Legal AI", sub: "Contract drafts, redlining, conflict check, anonymization.", features: [
      { icon: "FileText", title: "Contract Drafts", desc: "AI-generated drafts based on templates. T&Cs, employment contracts, purchase contracts, lease agreements." },
  ...
  arch: {
    ...
    items: [
      { icon: "Database", title: "72 API Endpoints", desc: "Complete REST API with auth, rate limiting, audit logging and TypeScript types." },
      { icon: "FolderOpen", title: "57 Dashboard Pages", desc: "Every function has its own responsive page — from the case file to the cost calculator." },
      { icon: "Shield", title: "Self-Hosted or EU Cloud", desc: "Local Docker installation or hosted in the EU with DPA. Data never leaves your control." },
      { icon: "Network", title: "Multi-Brain / Multi-Source", desc: "Multiple brains per organization, multiple sources per brain. Federated search over latent space." },
      { icon: "Lock", title: "End-to-End Encryption", desc: "At-rest and in-transit. No training on client data. Professional secrecy by design." },
      { icon: "Zap", title: "Real-Time Sync", desc: "WebSocket-based real-time updates between all clients. No refresh needed." },
    ],
  },
