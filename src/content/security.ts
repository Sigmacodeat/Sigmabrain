...
export const SECURITY: Record<Lang, SecurityContent> = {
  en: {
    ...
    pillars: [
      ...
      { icon: "Eye", title: "Auditable by design", desc: "Deterministic citations on every answer, request logging, and a trust boundary that treats every remote caller as untrusted by default — verify exactly where each claim comes from." },
    ],
    hostingTitle: "Two ways to run it",
    hostingSub: "Both keep you in control. Pick by your compliance posture.",
    hostingOptions: [
      { title: "Self-hosted / on-premise (Enterprise)", points: ["Your hardware, your jurisdiction, your keys", "No third party processes client data — relevant for statutory professional secrecy", "The complete engine, auditable, on your infrastructure", "You manage updates and backups"] },
  ...
  de: {
    ...
    pillars: [
      ...
      { icon: "Eye", title: "Auditierbar per Architektur", desc: "Deterministische Zitate in jeder Antwort, Request-Logging, und eine Trust-Boundary, die jeden Remote-Aufrufer standardmäßig als nicht vertrauenswürdig behandelt — prüft exakt, woher jede Aussage stammt." },
    ],
    hostingTitle: "Zwei Betriebsarten",
    hostingSub: "Beide lassen euch die Kontrolle. Wählt nach eurer Compliance-Lage.",
    hostingOptions: [
      { title: "Self-hosted / On-Premise (Enterprise)", points: ["Eure Hardware, eure Jurisdiktion, eure Keys", "Kein Dritter verarbeitet Mandantendaten — relevant für § 203 StGB: keine mitwirkende Person", "Die komplette Engine, auditierbar, auf eurer Infrastruktur", "Updates und Backups verwaltet ihr selbst"] },
