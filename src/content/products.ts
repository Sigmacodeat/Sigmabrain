...
export const PRODUCTS: Record<Lang, Record<ProductSlug, ProductContent>> = {
  en: {
    subsumio: {
      ...
      poweredBy: "Subsumio",
      metaTitle: "Subsumio — the law firm's brain",
      metaDesc: "Case files, deadlines, time, expenses, invoices and WhatsApp intake answerable in plain language — self-hosted, offline-capable or EU cloud. Built for law firms.",
    },
    taxumio: {
      slug: "taxumio",
      vertical: "tax",
  ...
  de: {
    subsumio: {
      ...
      poweredBy: "Subsumio",
      metaTitle: "Subsumio — das Kanzlei-Gehirn",
      metaDesc: "Akten, Fristen, Zeiten, Auslagen, Rechnungen und WhatsApp-Eingang in normaler Sprache abfragbar — self-hosted, offlinefähig oder EU-Cloud. Für Kanzleien gebaut.",
    },
    taxumio: {
      slug: "taxumio",
      vertical: "tax",
