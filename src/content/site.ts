...
export const NAV = {
  en: {
    ...
    solutionItems: [
      ...
      { label: "Real Estate — Immumio", href: "/realestate", desc: "Leases, tenants, renewals, due diligence — the property memory" },
      { label: "VC & Private Equity — Investumio", href: "/vc", desc: "Deal memory, founder tracking, the relationship graph" },
      { label: "Consulting & Agencies — Consultumio", href: "/consulting", desc: "Institutional memory: reuse past work, onboard fast" },
      { label: "Executive Search — Talentumio", href: "/recruiting", desc: "Your proprietary, queryable talent graph" },
    ],
  },
  de: {
    features: "Features",
    ...
    solutionItems: [
      ...
      { label: "Immobilien — Immumio", href: "/realestate", desc: "Mietverträge, Mieter, Verlängerungen, Due Diligence — das Objekt-Gedächtnis" },
      { label: "VC & Private Equity — Investumio", href: "/vc", desc: "Deal-Gedächtnis, Founder-Tracking, Beziehungsgraph" },
      { label: "Beratung & Agenturen — Consultumio", href: "/consulting", desc: "Institutional Memory: Vorarbeit wiederverwenden, schnell onboarden" },
      { label: "Executive Search — Talentumio", href: "/recruiting", desc: "Euer proprietärer, abfragbarer Talent-Graph" },
    ],
  },
} as const;
  ...
  en: {
    ...
    columns: [
      ...
      },
      {
        title: "Solutions",
        links: [
          { label: "VC & Private Equity", href: "/vc" },
          { label: "Law Firms", href: "/subsumio" },
          { label: "Subsumio · the law firm's brain", href: "/subsumio" },
          { label: "Tax & Accounting Firms", href: "/taxumio" },
          { label: "Taxumio · the tax firm's memory", href: "/taxumio" },
          { label: "Consulting & Agencies", href: "/consulting" },
          { label: "Executive Search & Recruiting", href: "/recruiting" },
        ],
      },
      {
        title: "Grow with us",
  ...
  de: {
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          { label: "VC & Private Equity", href: "/vc" },
          { label: "Kanzleien", href: "/subsumio" },
          { label: "Subsumio · das Kanzlei-Gehirn", href: "/subsumio" },
          { label: "Steuerberater & WP", href: "/taxumio" },
          { label: "Taxumio · das Kanzleigedächtnis", href: "/taxumio" },
          { label: "Beratung & Agenturen", href: "/consulting" },
          { label: "Executive Search & Recruiting", href: "/recruiting" },
        ],
      },
      {
...
⚠️ Gap: nothing new on Alice in 6 weeks. She may have replied on channels the brain doesn't see — ask.`,
    ...
    verticalCards: [
      ...
      { href: "/vc", title: "VC & Private Equity", desc: "Who invested in what? What's open with this founder? Walk into every meeting prepared.", cta: "For investors" },
      { href: "/consulting", title: "Consulting & Agencies", desc: "Pitch history, project learnings, client context — new hires productive in days.", cta: "For consultancies" },
      { href: "/recruiting", title: "Executive Search & Recruiting", desc: "Who fits the brief, who can intro you — a proprietary talent graph that compounds.", cta: "For search firms" },
    ],
...
⚠️ Lücke: Seit 6 Wochen nichts Neues zu Alice. Antwort kam evtl. über Kanäle, die das Brain nicht sieht — nachfragen.`,
    ...
    verticalCards: [
      ...
      { href: "/vc", title: "VC & Private Equity", desc: "Wer hat in was investiert? Was ist mit diesem Founder offen? In jedes Meeting vorbereitet gehen.", cta: "Für Investoren" },
      { href: "/consulting", title: "Beratung & Agenturen", desc: "Pitch-Historie, Projekt-Learnings, Kundenkontext — neue Kollegen in Tagen produktiv.", cta: "Für Beratungen" },
      { href: "/recruiting", title: "Executive Search & Recruiting", desc: "Wer passt aufs Mandat, wer kann euch vorstellen — ein proprietärer Talent-Graph, der sich verzinst.", cta: "Für Personalberater" },
    ],
