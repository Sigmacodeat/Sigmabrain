...
// HINWEIS: Ein SaaS ohne AGB hat keine durchsetzbaren Haftungsbegrenzungen,
// Zahlungsbedingungen oder Nutzungsregeln. Vor Launch anwaltlich erstellen lassen.
// Die Gliederung unten ist das Briefing für die Kanzlei, kein Vertragstext.
  ...
  return (
    <div className="min-h-screen bg-[#06060f] px-6 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-black text-[#e8e8f0] mt-8 mb-2">Allgemeine Geschäftsbedingungen</h1>
        <p className="text-xs text-[#4a4a6a] mb-8">AGB für die Nutzung von Sigmabrain</p>
        ...
        <div className="space-y-6 text-sm text-[#8888aa] leading-relaxed">
          ...
          <section>
            <h2 className="text-[#e8e8f0] font-semibold mb-2">Vorgesehene Gliederung</h2>
            <ol className="list-decimal list-inside space-y-1.5">
              ...
              <li>Partnerprogramm-Bedingungen (2-Ebenen-Provision, Auszahlung, Missbrauch)</li>
