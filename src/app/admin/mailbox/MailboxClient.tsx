                ...
                <li key={m.id}>
                  ...
                  >
                    <div className="flex items-center gap-2 mb-0.5">
                      {m.direction === "inbound" ? (
                        <Inbox size={12} className="text-violet-400 shrink-0" />
                      ) : (
  ...
  return (
    <div className="border-t border-[#1e1e3a] px-5 py-4 space-y-3 bg-[#0a0a18]">
      <textarea
        ...
        className="w-full rounded-lg border border-[#1e1e3a] bg-[#080812] px-3 py-2 text-sm text-[#e8e8f0] placeholder:text-[#7878a0] focus:border-violet-500/50 focus:outline-none"
      />
