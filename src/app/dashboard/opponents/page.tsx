  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-[color:var(--ds-text)]">Gegner-Analyse</h1>
          <p className="text-sm text-[color:var(--ds-text-muted)]">Intelligence über Gegner aus allen Akten</p>
        </div>
      </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <ChevronRight size={12} className="text-[color:var(--ds-text-muted)] group-hover:text-violet-600" />
                        </div>
                      </Link>
                    );
                  })}
            ...
            <div className="space-y-2">
              {opponents.map((o) => (
                <button
                  ...
                  className="w-full flex items-center gap-4 px-4 py-3 rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] hover:border-violet-500/30 hover:bg-violet-600/5 transition-all text-left group"
                >
                  ...
                  <ChevronRight size={16} className="text-[color:var(--ds-text-muted)] group-hover:text-violet-600 shrink-0" />
                </button>
              ))}
            </div>
          )}
