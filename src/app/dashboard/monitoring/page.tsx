...
export default function MonitoringPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="rounded-xl border border-[#e2e4ec] bg-[#ffffff] p-4 space-y-3">
        <div className="flex flex-wrap items-end gap-2">
          <div className="flex-1 min-w-[200px]">
            <label className="block text-xs text-[#585866] mb-1">Suchbegriff / Rechtsgebiet</label>
            <input
              value={newQuery}
          ...
          <div>
            <label className="block text-xs text-[#585866] mb-1">Jurisdiktion</label>
            <select
              value={newJur}
      ...
      {loading ? (
        <div className="flex items-center gap-2 text-sm text-[#585866]"><Loader2 size={15} className="animate-spin" /> Lade Watchlist…</div>
      ) : terms.length === 0 ? (
        <div className="text-center py-12 text-[#585866]">
        ...
        <div className="space-y-2">
          {terms.map((t, i) => (
            <div key={i} className="flex items-center justify-between rounded-lg border border-[#e2e4ec] bg-[#ffffff] px-4 py-3">
              <div>
