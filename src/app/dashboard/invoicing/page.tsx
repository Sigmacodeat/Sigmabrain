    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[color:var(--ds-text)]">Rechnungen</h1>
            <p className="text-sm text-[color:var(--ds-text-muted)]">Abrechnung & PDF-Export</p>
          </div>
        </div>
        <Button
          variant="primary"
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-3 text-center">
          <div className="text-xs text-[color:var(--ds-text-muted)]">Bezahlt</div>
          <div className="text-xl font-bold text-emerald-600">{totalPaid.toLocaleString("de-DE")} €</div>
        </div>
        <div className="rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-3 text-center">
          <div className="text-xs text-[color:var(--ds-text-muted)]">Rechnungen</div>
        ...
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 space-y-4">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                <label className="text-xs text-[color:var(--ds-text-muted)] block mb-1">Akte wählen</label>
                <select
                  value={selectedCase}
              ...
              <div>
                <label className="text-xs text-[color:var(--ds-text-muted)] block mb-1">Rechnungstyp</label>
                <select
                  value={invoiceType}
            ...
            <div>
              <label className="text-xs text-[color:var(--ds-text-muted)] block mb-1">Vorschuss / Anzahlung (€)</label>
              <input
                type="number"
                step="0.01"
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-[color:var(--ds-surface)] border border-[color:var(--ds-border)] rounded-lg pl-9 pr-3 py-2 text-sm text-[color:var(--ds-text)] placeholder:text-[color:var(--ds-text-muted)] focus:outline-none focus:border-emerald-500/50"
        />
      </div>

      {/* Invoice List */}
      {loading ? (
        <div className="text-center py-20 text-[color:var(--ds-text-muted)]">Lade Rechnungen…</div>
      ) : filtered.length === 0 ? (
        <div className="text-center py-20 space-y-4">
          <FileText size={48} className="mx-auto text-[color:var(--ds-border)]" />
          <p className="text-[color:var(--ds-text-muted)]">Noch keine Rechnungen vorhanden.</p>
          <p className="text-[color:var(--ds-text-muted)] text-sm">Erstellen Sie eine Rechnung aus einer Akte mit Zeiterfassung.</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="text-right shrink-0">
                  ...
                  <div className="text-xs text-[color:var(--ds-text-muted)]">inkl. MwSt.</div>
                </div>
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg text-[color:var(--ds-text-muted)] hover:text-violet-600 hover:bg-violet-500/10 transition-all"
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60" onClick={() => setOpen(false)}>
          <div className="w-full max-w-md rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-base font-semibold text-[color:var(--ds-text)]">RVG-Gebührenberechnung</h3>
            <div>
              <label className="text-xs text-[color:var(--ds-text-muted)] block mb-1">Streitwert (€)</label>
              <input
                type="number"
                value={streitwert}
                onChange={(e) => {
            ...
            {result && (
              <div className="space-y-2 text-sm">
                <div className="flex justify-between"><span className="text-[color:var(--ds-text-muted)]">Basisgebühr (1,0)</span><span className="text-[color:var(--ds-text)]">{result.basisGebuehr.toFixed(2)} €</span></div>
                <div className="flex justify-between"><span className="text-[color:var(--ds-text-muted)]">Verfahrensgebühr (1,3)</span><span className="text-[color:var(--ds-text)]">{result.verfahrensgebuehr.toFixed(2)} €</span></div>
                <div className="flex justify-between"><span className="text-[color:var(--ds-text-muted)]">Terminsgebühr (1,2)</span><span className="text-[color:var(--ds-text)]">{result.terminsgebuehr.toFixed(2)} €</span></div>
                <div className="flex justify-between"><span className="text-[color:var(--ds-text-muted)]">Auslagenpauschale</span><span className="text-[color:var(--ds-text)]">{result.auslagenpauschale.toFixed(2)} €</span></div>
                <div className="flex justify-between border-t border-[color:var(--ds-border)] pt-2"><span className="text-[color:var(--ds-text-muted)]">Netto</span><span className="text-[color:var(--ds-text)] font-medium">{result.summeNetto.toFixed(2)} €</span></div>
                <div className="flex justify-between"><span className="text-[color:var(--ds-text-muted)]">MwSt (19 %)</span><span className="text-[color:var(--ds-text)]">{result.mwst.toFixed(2)} €</span></div>
