    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[#e8e8f0]">Kalender-Export</h1>
            <p className="text-sm text-[#8888aa]">Fristen & Termine als iCal (.ics)</p>
          </div>
        </div>
        <Button
          variant="primary"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-xl border border-[#1e1e3a] bg-[#0a0a18] p-3 text-center">
          <div className="text-xs text-[#8a8aa8]">Anstehend</div>
          <div className="text-xl font-bold text-blue-400">{upcoming.length}</div>
        </div>
        <div className="rounded-xl border border-[#1e1e3a] bg-[#0a0a18] p-3 text-center">
          <div className="text-xs text-[#8a8aa8]">Überfällig</div>
      ...
      {/* Events */}
      {loading ? (
        <div className="text-center py-20 text-[#8888aa]">Lade Termine…</div>
      ) : filtered.length === 0 ? (
        <div className="text-center py-20 space-y-4">
          <CalendarClock size={48} className="mx-auto text-[#1e1e3a]" />
          <p className="text-[#8888aa]">Keine Termine gefunden.</p>
          <p className="text-[#8a8aa8] text-sm">Erstellen Sie Fristen in Akten oder nutzen Sie den Deadline-Extractor.</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {ev.description && (
                    <div className="text-xs text-[#8a8aa8] mt-1 line-clamp-1">{ev.description}</div>
                  )}
                </div>
                <div className="shrink-0 text-xs text-[#8a8aa8]">
