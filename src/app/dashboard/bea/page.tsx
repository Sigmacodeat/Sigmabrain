    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[color:var(--ds-text)]">beA — elektronischer Rechtsverkehr</h1>
            <p className="text-sm text-[color:var(--ds-text-muted)]">Nachrichten-Import und Entwurfsvorbereitung</p>
          </div>
        </div>
        <Button
          variant="primary"
      ...
      <div className="flex items-start gap-3 px-4 py-3 rounded-xl border border-amber-500/20 bg-amber-500/5" role="note">
        ...
        <div className="text-sm text-amber-600">
          ...
          <p className="text-xs leading-relaxed">
            ...
            Sigmabrain <strong>versendet keine Nachrichten</strong> — es importiert beA-Nachrichten
