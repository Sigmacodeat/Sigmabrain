      ...
      <div className="flex-1 relative bg-[color:var(--ds-bg)]">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            <Network size={40} className="text-[color:var(--ds-border)] mb-4" />
            <h3 className="text-lg font-semibold text-[color:var(--ds-text)] mb-2">Graph ist leer</h3>
            <p className="text-sm text-[color:var(--ds-text-muted)] mb-2">Lade Dokumente hoch um den Wissensgraph zu befüllen</p>
          ...
          <>
            ...
            <div className="absolute bottom-4 left-4 bg-[color:var(--ds-surface)]/90 backdrop-blur border border-[color:var(--ds-border)] rounded-xl p-4">
              <p className="text-xs text-[color:var(--ds-text-muted)] uppercase tracking-wider font-medium mb-3">Legende</p>
            ...
            <div className="absolute top-4 right-4 bg-[color:var(--ds-surface)]/90 backdrop-blur border border-[color:var(--ds-border)] rounded-xl p-4 text-right">
              <div className="text-xs text-[color:var(--ds-text-muted)] mb-2">Graph</div>
      ...
      {selected && (
        <div className="w-72 shrink-0 border-l border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] overflow-y-auto p-5">
          <div className="flex items-start gap-3 mb-5">
            ...
            <div>
              <h3 className="text-base font-semibold text-[color:var(--ds-text)]">{selected.name}</h3>
          ...
          <div className="space-y-4">
            <div>
              <p className="text-xs text-[color:var(--ds-text-muted)] uppercase tracking-wider mb-2">Slug</p>
              <p className="text-sm font-mono text-violet-600 bg-violet-500/10 px-3 py-2 rounded-lg">{selected.id}</p>
            </div>
            <div>
              <p className="text-xs text-[color:var(--ds-text-muted)] uppercase tracking-wider mb-2">Verbindungen</p>
              <p className="text-2xl font-bold text-[color:var(--ds-text)] font-mono">{selected.connections}</p>
            </div>

            <div>
              <p className="text-xs text-[color:var(--ds-text-muted)] uppercase tracking-wider mb-2">Kanten</p>
              {links.filter((l) => {
