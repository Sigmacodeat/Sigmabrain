  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-[color:var(--ds-text)]">Löschfristen</h1>
          <p className="text-sm text-[color:var(--ds-text-muted)]">DSGVO + BRAO — Aufbewahrungsfristen prüfen</p>
        </div>
      </div>
