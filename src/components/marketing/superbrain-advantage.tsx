...
const copy = {
  en: {
    ...
    proof: [
      ...
      { icon: ShieldCheck, title: "Deployment choice", desc: "Open-source engine, self-hosted, your keys, or managed EU cloud when you want speed." },
    ],
    ...
    comparisons: [
      ...
      { label: "Enterprise AI suites", weak: "start expensive and closed", strong: "start open, branch-specific and ownable" },
    ],
  ...
  de: {
    ...
    proof: [
      ...
      { icon: ShieldCheck, title: "Deployment-Wahl", desc: "Open-Source-Engine, self-hosted, eigene Keys, oder gemanagte EU-Cloud wenn es schnell gehen soll." },
    ],
    ...
    comparisons: [
      ...
      { label: "Enterprise-KI-Suiten", weak: "starten teuer und geschlossen", strong: "starten offen, branchenspezifisch und kontrollierbar" },
    ],
