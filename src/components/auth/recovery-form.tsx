            ...
            <div className="space-y-4">
              ...
              {devResetUrl && (
                <div className="p-4 rounded-xl border border-amber-500/20 bg-amber-500/5">
                  ...
                  <a href={devResetUrl} className="text-xs text-violet-400 hover:underline break-all">
                    {devResetUrl}
                  </a>
                </div>
              )}
              <Link href={p(lang, "/login")} className="inline-flex items-center gap-1.5 text-sm text-violet-400 hover:underline">
