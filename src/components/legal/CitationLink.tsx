...
export function CitationLink({ citation, className }: CitationLinkProps) {
  ...
  return (
    <Link
      ...
      className={cn(
        "inline-flex items-center gap-1 text-violet-400 hover:text-violet-300 underline underline-offset-2 decoration-violet-500/30 hover:decoration-violet-400 transition-all cursor-pointer",
        className
      )}
    >
      <BookOpen size={10} />
