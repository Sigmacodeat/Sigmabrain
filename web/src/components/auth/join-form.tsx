...
const COPY = {
  en: {
    title: "Join the team",
    sub: "You've been invited to a shared Sigmabrain — one brain, the whole team's knowledge.",
  ...
  de: {
    ...
    sub: "Du wurdest zu einem geteilten Sigmabrain eingeladen — ein Brain, das Wissen des ganzen Teams.",
    ...
    <div className="min-h-screen bg-[#06060f] flex items-center justify-center px-6 py-12" lang={lang}>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl shadow-black/50">
          <Users size={22} className="text-violet-400 mb-4" aria-hidden />
          ...
          {doneName ? (
            <div className="space-y-4">
              ...
              <Link href="/dashboard" className="inline-flex items-center gap-1.5 text-sm text-violet-400 hover:underline">
