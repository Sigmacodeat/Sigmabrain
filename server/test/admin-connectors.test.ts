...
import { ConnectorManager, CONNECTOR_REGISTRY, SUPPORTED_CONNECTORS } from '../src/core/ingestion/connectors/manager.ts';
...
describe('ConnectorManager admin API surface', () => {
  ...
  test('CONNECTOR_REGISTRY exports all 9 connectors', () => {
    ...
    expect(Object.keys(CONNECTOR_REGISTRY)).toHaveLength(9);
  });
});
